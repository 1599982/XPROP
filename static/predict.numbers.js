...
function initDOMElements() {
    ...
    // letterTemplate no es necesario para números hardcodeados

    // Event listener para limpiar texto
    clearTextButton.addEventListener('click', clearDetectedText);

    // Los números y operaciones ya están hardcodeados en el HTML
    console.log('Números y operaciones cargados desde HTML');
}
...
function drawResults(results) {
    ...
    if (isLeftHandDetected && leftHandLandmarks) {
        ...
        drawHandLabel(leftHandLandmarks[0], "IZQUIERDA - NÚMEROS", "#00ff00");
    }
...
function drawNoHandMessage() {
    ...
    context.fillText('Sistema de Calculadora en Señas', canvas.width / 2, canvas.height / 2 - 50);
    context.font = 'bold 14px Arial';
    context.fillStyle = '#00ff00';
    context.fillText('🟢 MANO IZQUIERDA: Hacer señas de números y operaciones', canvas.width / 2, canvas.height / 2 - 25);
    context.fillStyle = '#0088ff';
    context.fillText('🔵 MANO DERECHA: Cerrar puño para escribir', canvas.width / 2, canvas.height / 2 - 5);
    context.fillStyle = '#ffffff';
    context.font = 'bold 12px Arial';
    context.fillText('• Confianza de símbolo > 80% para escribir', canvas.width / 2, canvas.height / 2 + 20);
